         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-header d-flex"style="justify-content: space-between;">
                  ...
                  <div>
                     <a class="btn btn-primary" href="{{ url('admin/executive/create') }}"><b><i class="fa fa-plus"></i> Add Executive</b></a>
                  </div>
               </div>
                  ...
                  <div class="table-responsive">
                     <table id="basic-datatables" class="display table table-striped table-hover">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td>{{ $sr++ }}</td>
                              <td>{{$list->executive_unique_id ?? ''}}</td>
                              <td>{{$list->name ?? ''}}</td>
                              <td>{{$list->email ?? ''}}</td>
                              <td>{{$list->mobile ?? ''}}</td>
                              <td>{{$list->voter_id ?? ''}}</td>
