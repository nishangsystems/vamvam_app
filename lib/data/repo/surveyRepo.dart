...
class SurveyRepo {
  ...
  SurveyRepo({required this.dioClient, required this.prefs});

  // Get Survey
  Future<ApiResponse> getSurvey({required String userId}) async {
    try {
      Response response =
          await dioClient.post(ApiConstant.survey, data: {'user_id': userId});
  ...
  Future<ApiResponse> submitSurvery(
    ...
    try {
      Response response = await dioClient.post(ApiConstant.submitSurvey, data: {
        'user_id': userId,
  ...
  Future<ApiResponse> leaderStoreSurvey(
    ...
    try {
      Response response = await dioClient.post(ApiConstant.leaderStoreSurvey,
