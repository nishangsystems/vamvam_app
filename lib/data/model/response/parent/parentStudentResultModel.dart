class ParentStudentResultModel {
  ParentStudentResultData? data;

  ParentStudentResultModel({this.data});

  ParentStudentResultModel.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null
        ? ParentStudentResultData.fromJson(json['data'])
        : null;
  }
...
class ParentStudentResultData {
  ...
  ParentStudentResultData.fromJson(Map<String, dynamic> json) {
    title = json['title'];
    ...
    if (json['grading'] != null) {
      grading = <Grading>[];
      json['grading'].forEach((v) {
        grading!.add(Grading.fromJson(v));
      });
    }
