...
class RepresantativeEventScreen extends StatefulWidget {
  const RepresantativeEventScreen({super.key});

  @override
  State<RepresantativeEventScreen> createState() =>
      _RepresantativeEventScreenState();
}

class _RepresantativeEventScreenState extends State<RepresantativeEventScreen> {
  var selectIndex = 0;
  @override
