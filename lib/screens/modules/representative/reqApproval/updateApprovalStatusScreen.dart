...
class UpdateApprovalStatusScreen extends StatefulWidget {
  final String approvalId;
  const UpdateApprovalStatusScreen({super.key, required this.approvalId});

  @override
  State<UpdateApprovalStatusScreen> createState() =>
      _UpdateApprovalStatusScreenState();
}

class _UpdateApprovalStatusScreenState
    extends State<UpdateApprovalStatusScreen> {
                        ...
                        child: DropdownButton(
                            ...
                            hint: const Text('Select Approval Status',
                                style: TextStyle(
                                    ...
                                    color: black,
                                    fontSize: 12)),
                            items: ['Approved', 'Reject'].map((items) {
                  ...
                  commonButtonWhite(
                      ...
                      onTap: () {
                        if (descriptionError != null) {
                          errorToast(msg: 'Enter Message');
                        } else if (selectedStatus == null) {
                          errorToast(msg: 'Select Approval Status!');
                        } else {
                          approval
