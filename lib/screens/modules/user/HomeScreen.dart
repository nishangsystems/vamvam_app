...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Provider.of<ProfileProvider>(context, listen: false).getProfile(auth.getUserId(), register,
  ...
  Widget get gridSec => Consumer6<ProfileProvider, HomeProvider, AuthProvider,
        ...
        builder: (context, profile, home, auth, register, surveyProvider, role,
          ...
          return Consumer3<AddComplaintProvider, EventProvider,
              AppointmentProvider>(
            builder: (context, complaint, eventPro, appointment, child) =>
              ...
              child: GridView(
                ...
                padding: EdgeInsets.only(
                    top: ResponsiveHelper.height(context) * 0.02),
