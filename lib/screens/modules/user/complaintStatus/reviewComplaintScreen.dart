...
class ReviewComplaintScreen extends StatefulWidget {
  ...
  const ReviewComplaintScreen({super.key, required this.complaintId});
                  ...
                  child: Form(
                    child: Column(
                      ...
                      children: [
                        ...
                        //                     )
                        //               // child:
                        //               // Image.asset(IconResource.addComplaintIcon4),
                        //               )),
                        //     ),
                        //   ],
                        // ),
                            ...
                            onTap: () {
                              if (remarkController.text.isEmpty) {
                                ...
                                data
                                    .reviewComplaint(
                                        widget.complaintId,
                                        remarkController.text.trim().toString(),
                                        list)
                                    .then((value) {
                                  if (value.isSuccess) {
