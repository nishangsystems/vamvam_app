...
class PanchayatWardController extends Controller
{
    use MessageStatusTrait;

    # Bind Type
    protected $type = 'Panchayat/Ward ';

    # Bind location
    protected $view = 'admin.master.panchayat_ward.';

    # Bind tehsil
    protected $tehsil;
    protected $state;
    protected $district;
    protected $panchayatWard;
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()){
          ...
          try{
                ...
                $checkDuplicate = $this->panchayatWard
                ...
                if($checkDuplicate != '')
                {
                  return response()->json([
                                    (string)$this->responseCode    => (string)$this->errorStatus, 
                                    (string)$this->responseMessage => 'Sorry, this panchayat/ward already added',
                                ]);  
                }
                ...
                #store
                $create = $this->panchayatWard->create($arrayData);
               
                return response()->json([
                                        (string)$this->responseCode    => (string)$this->successStatus, 
                                        (string)$this->responseMessage => 'Panchayat/Ward Added Successfully',
                                    ]); 
    ...
    public function update(Request $request)
    {
        ...
        try {
               ...
               #update
                ...
                return response()->json([
                        (string)$this->responseCode =>(string)$this->successStatus, 
                        (string)$this->responseMessage => 'Panchayat/Ward Updated Successfully!',
                    ]);                
