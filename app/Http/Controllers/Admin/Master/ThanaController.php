...
class ThanaController extends Controller
{
    ...
    # Bind Type
    protected $type = 'Thana ';

    # Bind location
    protected $view = 'admin.master.thana.';
        ...
        if($validator->fails()){
          ...
          try{
                ...
                if($checkDuplicate != '')
                {
                  return response()->json([
                                    (string)$this->responseCode    => (string)$this->errorStatus, 
                                    (string)$this->responseMessage => 'Sorry, this thana already added',
                                ]);  
                }
                ...
                #store
                $create = $this->thana->create($arrayData);
               
                return response()->json([
                                        (string)$this->responseCode    => (string)$this->successStatus, 
                                        (string)$this->responseMessage => 'Thana Added Successfully',
                                    ]); 
    ...
    public function update(Request $request)
    {
        ...
        try {
               ...
               #update
                ...
                return response()->json([
                        (string)$this->responseCode =>(string)$this->successStatus, 
                        (string)$this->responseMessage => 'Thana Updated Successfully!',
                    ]);                
