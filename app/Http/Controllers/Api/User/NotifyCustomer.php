...
class NotifyCustomer extends Controller
{
   ...
   * @return
   */
  public function notify($customer, $title = '', $message= '', $complaint_id= '', $type= '')
  {
 ...
 /**
   ...
   * @return
   */
  function iOS($customer, $title = '', $message= '', $complaint_id= '', $type= '')     
  {  
